...
| Conceptual / registry files | **20** (incl. diagnostics foundation, Master Integration v1.1, Unified Energy Catalog, Diagnostic Algorithms) |
| Symptom DB (CONCORD-500) | **100** symptoms (SYM-056..155, patch 01) |
| Test suite | **824 passing, 0 skipped** |
...
+ full Mark-canonical core. **COMPLETE: 20-batch plan + DX-21 niche labs = 21 batches / 248 entries** — lab (DX-01..11, TST), imaging (DX-12..15, IMG), functional (DX-16/17/18, FUN), procedures (DX-19/20, PRO), niche (DX-21: CSF/toxicology/genetics/salivary).
...
energy-mapping / Cole-Cole membrane = `[RF]` hypotheses; KCTS EBM-reframed.
